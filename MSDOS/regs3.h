...
#ifndef FLY8_MSDOS_REGS3_H
#define FLY8_MSDOS_REGS3_H
 ...
 */
#define vgaCRIndex		0x03d4
#define vgaCRReg		0x03d5
#define vgaBase			((unsigned char far *)0xa0000000L)

#define UNLOCK_SYS_REGS		do { \
				   outb(vgaCRIndex, 0x39); \
				   outb(vgaCRReg, 0xa5); } while (0)

#define LOCK_SYS_REGS		do { \
				   outb(vgaCRIndex, 0x39); \
...
#define WaitIdle() do { while (inw(GP_STAT) & GPBUSY) \
				sys_poll (97); } while(0)
