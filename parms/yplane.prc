...
F(-0.30),	/* Cmde	elevators effectiveness				*/
F10(-8.00),	/* Cmq	pitch damping					*/
F(-0.40),	/* Cmalpha wing/stabilizer induced pitch		*/
...
*/
	MODEL_YPLANE,	/* flight dynamics model			*/
